...
<body>
    ...
    <?php echo $__env->make('components.hero-section', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            ...
            <div class="bg-gradient-to-r from-blue-900 to-blue-800 rounded-3xl p-12 text-white">
                <div class="grid md:grid-cols-2 gap-12 items-center">
                    <div>
                        ...
                        <div class="flex items-center">
                            <img src="<?php echo e(asset('images/president.jpg')); ?>" alt="Président" class="w-16 h-16 rounded-full mr-4">
                            <div>
                    ...
                    <div class="text-center">
                        <img src="<?php echo e(asset('images/president-full.jpg')); ?>" alt="Président" class="rounded-2xl shadow-2xl">
                    </div>
                </div>
            </div>
        </div>
...
</html><?php /**PATH C:\Users\HP\association-tivaouane\resources\views/welcome.blade.php ENDPATH**/ ?>