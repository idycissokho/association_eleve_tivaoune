<?php $__env->startSection('title', 'Actualites - AELT 93-97'); ?>
...
<section class="py-20 bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-wrap gap-4 mb-12 justify-center">
            <a href="<?php echo e(route('posts.index')); ?>" class="px-6 py-3 bg-blue-600 text-white rounded-full font-semibold hover:bg-blue-700 transition-colors">
                Toutes
            </a>
            <a href="<?php echo e(route('posts.index', ['category' => 'evenement'])); ?>" class="px-6 py-3 bg-white text-gray-700 rounded-full font-semibold hover:bg-gray-100 transition-colors">
                Evenements
            </a>
            <a href="<?php echo e(route('posts.index', ['category' => 'projet'])); ?>" class="px-6 py-3 bg-white text-gray-700 rounded-full font-semibold hover:bg-gray-100 transition-colors">
                Projets
            </a>
            <a href="<?php echo e(route('posts.index', ['category' => 'annonce'])); ?>" class="px-6 py-3 bg-white text-gray-700 rounded-full font-semibold hover:bg-gray-100 transition-colors">
                Annonces
            </a>
        </div>
