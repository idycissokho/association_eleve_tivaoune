...
@section('title', 'À propos - Association des Anciens Élèves du Lycée de Tivaouane')
...
<section class="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-blue-900 via-blue-800 to-indigo-900">
    <div class="absolute inset-0 opacity-50">
        <img src="{{ asset('images/monument.jpeg') }}" alt="Membres" class="w-full h-full object-cover">
    </div>
        ...
        <div class="grid lg:grid-cols-2 gap-16 items-center">
            <div class="hover-lift">
                <div class="relative">
                    ...
                    <img src="{{ asset('images/officiel.jpeg') }}" alt="Promotion 1993-1997" 
