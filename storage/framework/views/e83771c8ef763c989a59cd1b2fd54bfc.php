<?php $__env->startSection('title', 'Accueil - AELT 93-97'); ?>
...
<section class="relative bg-gradient-to-br from-blue-900 via-blue-800 to-blue-900 text-white overflow-hidden">
    ...
    <div class="absolute inset-0 opacity-40">
        <img src="<?php echo e(asset('images/officiel.jpeg')); ?>" alt="Membres" class="w-full h-full object-cover">
    </div>
        ...
        <div class="bg-gradient-to-br from-blue-900 via-blue-800 to-blue-900 rounded-3xl overflow-hidden shadow-2xl">
            <div class="grid md:grid-cols-2 gap-0">
                ...
                <div class="relative h-96 md:h-auto">
                    ...
                    <img src="<?php echo e(asset('images/directeur.jpeg')); ?>" alt="President" class="w-full h-full object-cover">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\HP\association-tivaouane\resources\views/home.blade.php ENDPATH**/ ?>